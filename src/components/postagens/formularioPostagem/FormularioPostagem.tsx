...
function FormularioPostagem() {
  ...
  return (
    <div className="container flex flex-col mx-auto items-center mb-4">
      ...
      <form onSubmit={gerarNovaPostagem} className="flex flex-col w-1/2 gap-4">
        ...
        <button
          ...
          type="submit"
          className="rounded disabled:bg-slate-200 bg-cyan-600 hover:bg-cyan-800 text-stone-100 font-bold w-1/2 mx-auto block py-2"
        >
          {carregandoTema ? (
